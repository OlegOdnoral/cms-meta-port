...
export interface ApiAvailableLocalizationAvailableLocalization
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    htmlValue: Schema.Attribute.String;
    ...
    > &
      Schema.Attribute.Private;
    parnter_localization: Schema.Attribute.Relation<
      'oneToOne',
...
export interface ApiColorSchemaColorSchema extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    pertner_config: Schema.Attribute.Relation<
      'oneToOne',
...
export interface ApiPartnerConfigPartnerConfig
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    available_localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::available-localization.available-localization'
    >;
    avatar: Schema.Attribute.String;
    budget: Schema.Attribute.String;
    color_schema: Schema.Attribute.Relation<
      'oneToOne',
      'api::color-schema.color-schema'
    >;
    createdAt: Schema.Attribute.DateTime;
    ...
    pertner_logo: Schema.Attribute.Media<
...
export interface ApiPartnerPartner extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    parnter_localization: Schema.Attribute.Relation<
      ...
      'api::parnter-localization.parnter-localization'
    >;
    parnter_localization_content: Schema.Attribute.Relation<
      'oneToOne',
      'api::parnter-localization.parnter-localization'
    >;
    partner_config: Schema.Attribute.Relation<
      'oneToOne',
      'api::partner-config.partner-config'
    >;
    partner_id: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
